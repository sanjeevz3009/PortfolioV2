...
SECRET_KEY = os.environ.get(
    "DJANGO_SECRET_KEY",
    "dev-only-insecure-key",  # fine for local dev only
)

DEBUG = os.environ.get("DJANGO_DEBUG", "0") == "1"

raw_hosts = os.environ.get("DJANGO_ALLOWED_HOSTS", "")
ALLOWED_HOSTS = ["*"] if DEBUG else [h.strip() for h in raw_hosts.split(",") if h.strip()]
...
STATICFILES_DIRS = [BASE_DIR / "static"]  #  source static (repo)
